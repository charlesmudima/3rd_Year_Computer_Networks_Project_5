    ...
    public void run() {
        try {
            ...
            while (true) {
                ...
                objBIS.read(byte_arr, 0, (int) myFile.length()); // reads the file senr from Server.java

                // System.out.println("Sending the file of " +byte_arr.length+ " bytes");

                objOS.write(byte_arr, 0, byte_arr.length); // sends this file name to the Client
